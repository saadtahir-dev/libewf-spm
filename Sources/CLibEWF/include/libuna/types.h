...
#if !defined( _LIBUNA_TYPES_H )
#define _LIBUNA_TYPES_H
...
#define __USE_UNIX98
#define LIBUNA_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBUNA_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBUNA_DEFINITION_UNIX98
#endif
...
/* UTF-16 character definition
 */
typedef uint16_t libuna_utf16_character_t;

/* UTF-32 character definition
 */
